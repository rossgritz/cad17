...
def iresb(inl, sz=32):
  c1 = conv3d(sz,kernel_size=1)(inl)
  c2 = conv3d(sz,kernel_size=1)(inl)
  c2b = conv3d(sz,kernel_size=(5,1,1))(c2)
  c2c = conv3d(sz,kernel_size=(1,5,1))(c2b)
  c2d = conv3d(sz,kernel_size=(1,1,5))(c2c)
  concat = concatenate([c1,c2d],axis=1)
  c4 = conv3d(int(inl.shape[1]),kernel_size=1)(concat)
  suml = add([inl,c4])
  selu = Activation('selu')(suml)
  return selu
...
def getModel(outputs=2, sz=64,dropout=0.1):
  ...
  res5 = iresa(c4,sz=32)
  c5 = conv3d(int(res4.shape[1])//2,kernel_size=1)(res5)
  fl1 = Flatten()(c5)
  fc1 = Dense(192,kernel_initializer='lecun_normal')(fl1)
