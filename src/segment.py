...
sys.path.append('/home/rrg0013@auburn.edu/keras/keras/preprocessing/')
...
config.gpu_options.per_process_gpu_memory_fraction=0.9945
set_session(tf.Session(config=config))

DATAPATH =  '/scr/data/nodules/luna/test/subset0/'
ANNOTATIONS = '/home/rrg0013@auburn.edu/git/nodules/resources/annotations.csv'
WEIGHTSPATH = '/scr/data/nodules/testseg/final/one.h5'
OUTPATH = '/scr/data/nodules/testseg/final/finalt/zero_/'
OUTFILE = '/scr/data/nodules/testseg/final/finalt/zero_.txt'
